* MMA21P1PANBASIC.DO  March 2005 for Stata version 8.0

log using mma21p1panbasic.txt, text replace

********** OVERVIEW OF MMA21P1PANBASIC.DO **********
...
* For alternative way to get panel-robust standard errors and 
* to do valid Hausman test see ch21panel2.do 
* For residual correlations see ch21panel3.do  (Tables 21.2-21.3)
* For pooled FGLS under different error assumptions see ch21panel4.do
...
* This test is only valid if the RE model is correctly specified.
* This is not the case here
* Instead do the robust variant given in another program
...
estimates table polsiid polshet polspanel beiid feiid, /*
   */ se stats(N ll r2 tss rss mss rmse df_r) b(%10.4f)
estimates table fdiffiid fdiffhet fdiffpanel reglsiid remleiid, /*
   */ se stats(N ll r2 tss rss mss rmse df_r) b(%10.4f)
estimates table paiid, se stats(N ll r2 tss rss mss rmse df_r) b(%10.4f)
